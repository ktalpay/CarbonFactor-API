...
- **Implemented artifacts:** `carbonfactor_api/contracts.py`, `docs/api-contract.md`.
...
## Error model
- **Implemented artifacts:** `carbonfactor_api/errors.py`, transport error envelopes in `carbonfactor_api/transport/models.py`.
...
- **Implemented artifacts:** `carbonfactor_api/catalog.py`, synthetic records in `carbonfactor_api/data/sample_factors.py`.
...
## Transport boundary
- **Implemented artifacts:** `carbonfactor_api/transport/*`, `docs/transport-boundary.md`.
...
## FastAPI adapter
- **Implemented artifacts:** `carbonfactor_api/http/app.py`, `docs/http-adapter.md`.
...
- **Implemented artifacts:** query validation in `carbonfactor_api/http/app.py`; tests in `tests/http/test_query_validation.py`.
...
- **Implemented artifacts:** `tests/http/test_openapi_contract.py`.
...
- **Implemented artifacts:** `tests/http/test_error_consistency.py`, transport tests under `tests/transport/`.
...
- **Implemented artifacts:** `.github/workflows/ci.yml`, `python -m pytest -q` test suite.
