...
- **Implemented artifacts:** `src/python/src/carbonops_api/contracts.py`, `docs/api-contract.md`.
...
## Error model
- **Implemented artifacts:** `src/python/src/carbonops_api/errors.py`, transport envelopes in `src/python/src/carbonops_api/transport/envelope.py`.
...
- **Implemented artifacts:** `src/python/src/carbonops_api/catalog.py`, synthetic records in `src/python/src/carbonops_api/sample_data.py`.
...
## Transport boundary
- **Implemented artifacts:** `src/python/src/carbonops_api/transport/`, `docs/transport-boundary.md`.
...
## FastAPI adapter
- **Implemented artifacts:** `src/python/src/carbonops_api/http/app.py`, `docs/http-adapter.md`.
...
- **Implemented artifacts:** query validation in `src/python/src/carbonops_api/http/query.py` and `src/python/src/carbonops_api/http/routes.py`; tests in `src/python/tests/test_http_query.py`.
...
- **Implemented artifacts:** `src/python/tests/test_http_openapi.py`.
...
- **Implemented artifacts:** `src/python/tests/test_http_routes.py`, `src/python/tests/test_http_integration.py`, and transport tests (`src/python/tests/test_transport_envelope.py`, `src/python/tests/test_transport_status.py`, `src/python/tests/test_transport_serialization.py`, `src/python/tests/test_transport_handlers.py`).
...
- **Implemented artifacts:** `.github/workflows/test.yml`, `src/python` test suite executed with `python -m pytest -q`.
